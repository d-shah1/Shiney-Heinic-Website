                        ...
                        <div class="col-md-8 shadow order-md-1 p-5 form-left">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        class="form-control mb-3 StripeElement StripeElement--empty" placeholder="Phone"
                                        required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="address" id="address"
                                    class="form-control mb-3 StripeElement StripeElement--empty" placeholder="Address"
                                    required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="state" id="state"
                                        class="form-control mb-3 StripeElement StripeElement--empty" placeholder="state"
                                        required>
                                </div>
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input StripeElement StripeElement--empty"
                                    name="check_add" id="check">
                            ...
                            <div class="col-md-12 order-md-1 form-left" id="address_ship_modal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-12">
                                        <label for="address">Address </label>
                                        <input required type="text" name="address_ship" id="address_ship"
                                            class="form-control mb-3 StripeElement StripeElement--empty"
                                            placeholder="Address">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mb-3">
                                            <label for="country">Country</label>
                                            <input required type="text" name="country_ship" id="country_ship"
                                                class="form-control mb-3 StripeElement StripeElement--empty"
                                                placeholder="country">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="state">State</label>
                                            <input required type="text" name="state_ship" id="state_ship"
                                                class="form-control mb-3 StripeElement StripeElement--empty"
                                                placeholder="state">
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="zip">Zip</label>
                                            <input required type="text" name="zip_ship" id="zip_ship"
                                                class="form-control mb-3 StripeElement StripeElement--empty"
