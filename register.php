...
<head>
    ...
    function checkps() {
        ...
        if (reg.test(data)) {
            ...
            dc.innerHTML =
                "Password must contain atleast one Capital Character && Special Character && Digit && Length must be greater than 8";
    ...
    function passwordcheck() {
        ...
        if (!pass1) {
            ...
            if (pass1 == pass2) {
                ...
                dc.style.color = "red";
                dc.style.display = "block";
                dc.innerHTML = "Password and Confirm Password does not match!";
                var submit = document.getElementById("submit");
                            ...
                            <div class="col-lg-6 col-sm-12 right-form">
                                ...
                                <div class="mb-3 email-field">
                                    <div class="col mb-3">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            placeholder="name@example.com" required></input>
                                    </div>
                                </div>
                                <div class="mb-3 password-field">
                                    <div class="col mb-3">
                                        <label for="form-label" class="form-label">Password</label>
                                        <input type="password" id="password1" onkeyup="checkps()" name="password"
                                ...
                                <div class="mb-3 password-field">
                                    <div class="col mb-3">
                                        ...
                                        <input type="password" id="password2" onkeyup="checkrps()" name="re_password"
                                            class="form-control" placeholder="re-Password" required></input>
                                    </div>
                                </div>
                                <button id="submit" type="submit" class="btn btn-primary mt-3"
                                    style="background-color: #75CFB8; border: none; color: #fff; font-family: Gilroy-Regular, sans-serif "
                                    disabled="true">Register</button>
                                <p class="register-link">Already have an account ? <a href="./login.php">Login Now</a>
                                </p>
                            </div>
                        </div>
                    </form>
