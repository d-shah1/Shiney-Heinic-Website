...
<body>
    <div class="main-wrapper">
            ...
            <div class="container" style="max-width: 1340px;">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-details">
                        ...
                        <p class="product-detail mt-4">The Shiney Heinie Classic is a bidet designed to attach to any
                            toilet giving you a cleaner heinie after your number 2 than toilet paper ever could.
                            Experience the gentle and hygienic wash Shiney Heinie Classic provides with just a turn of a
                            knob. You’ll never want to go back to just toilet paper again.</p>
                        <p class="product-detail mt-4">Regular Sale Price <del class="product-price">99.99$</del> <span
                                class="product-price">69.99$</span></p>
                        <ul class="product-detail-list mt-4">
                            <li><b>Simple Design.</b> Minimalistic and sleek design for easy use and no interference.
                                Shiney Heinie brings you an easy to use and modern product that's the perfect pair to
                                your toilet.</li>
                            <li><b>Complete Package.</b> The Classic is simply the complete package as it provides you
                                with everything you need for a fast and easy install.</li>
                            <li><b>Does Not require any electricity or plumbing.</b> for set up. Shiney Heinie Classic
                                only needs to be hooked up to your existing plumbing with the adapter for use</li>
                            <li><b>Dual Nozzle.</b> Comes with a front and rear nozzle for a precise stream and women's
                                use. (Ladies you're welcome 😉)</li>
                            <li><b>Pressure Control.</b> You can control the pressure of your wash from a gentle spray
                                to full pressure.</li>
                            <li><b>Nozzle Guard. </b>Whenever your bidet system is not in use the nozzle will simply
                                retract into the nozzle guard. Preventing from contamination.</li>
                            <li><b>Easy Clean.</b>Cleaning your bidet system is simple and easy with any standard
                                detergents.</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Wash your butt like you do every other body part, to help with UTI’s, hemorrhoids,
                                underwear stains, and those late night taco bell runs.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <div class="tips-image">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Shiney Heinie cuts down your TP usage by upto 75%. Helping you save thousands over time.
                            </p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="tips-desc pt-1">
                            <p>It takes 15 million trees to make the annual supply of TP. It also takes 37 gallons of
                                water to make just one roll of toilet paper. Whereas, using Shiney Heinie consumes about
                                a pint of water.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Not only does it take a lot of water and trees to produce toilet paper, but toilet paper
                                production is also coming at the cost of homes and habitats for all the other species.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 installation-steps">
                        ...
                        <p class="sub-title">Installation is easy and does not require any additional tools.<br />Less
                            then a 9 minute set up time</p>
      ...
      if (isset($_SESSION['email'])) {
         ...
         $trans_result = $con->query("SELECT count(user_id) as total from transaction where `user_id`='$user_id' and `shiney_heinie_classic`<>'0'");

         $trans_row = mysqli_fetch_assoc($trans_result);
         $total_trans = $trans_row['total'];

         $reviews = $con->query("SELECT count(user_id) as total from classic_review where `user_id`='$user_id'");
         $review_row = mysqli_fetch_assoc($reviews);

         $total_reviews = $review_row['total'];

         if ($total_reviews < $total_trans) {
            $style = "";
      ?>
        ...
        <div class="benefits-section" style="margin-top: 30px;" id="ViewReviewDiv">
            <div class="container" id="container">
                <div class="row text-center">
                    ...
                    <div class="col-lg-12 col-sm-12 section-desc">
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae voluptate repellendus
                            magni illo ea animi Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae
                            voluptate repellendus magni </p>
                    </div>
                </div>
