...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="container" style="max-width: 1340px;">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 product-details">
                        ...
                        <p class="product-detail mt-4">Get a hygienic, gentle wash of clean water at the turn of a knob.
                            Instantly attaches to any toilet. No professional installation needed. You’ll never go back
                            to TP again. </p>
                        <p class="product-detail mt-4">Regular Sale Price <del class="product-price">39.99$</del> <span
                                class="product-price">24.99$</span></p>
                        <ul class="product-detail-list mt-4">
                            <li><b>Angle customization.</b> Get a precise clean every time.</li>
                            <li><b>Pressure customization.</b> Enjoy back and front wash at your preferred comfort
                                level.</li>
                            <li><b>Backside certified.</b> Get the same sparkling-clean feeling that all Shiney Heinie
                                products provide..</li>
                            <li><b>Standard size.</b> Attach the bidet to any toilet seat in perfect fit.</li>
                            <li><b>Complete Spa.</b> Spend less as the box includes everything you need for a convenient
                                installation.</li>
                        </ul>
                        <!-- <div class="btn-buy">
                ...
                <div class="row text-center">
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Work. Vacantions. That Yurt you rented. Take a carefree, cleen dump wherever, whenever.
                                (No Shakira)</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Discreet and collapsible because everyone doesn`t need to know your business. Though
                                you`ll probably brag about it anyway.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <div class="tips-image">
                        ...
                        <div class="tips-desc pt-1">
                            <p>With Shiney Hinney Travel, you`ll use less toilet paper reducing your carbon footprint.
                                Toilet paper has met its match.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12">
                        <div class="tips-image">
                        ...
                        <div class="tips-desc pt-1">
                            <p>Celebrate your butt and clean it right with the perfect streem of cleansign water to wash
                                your travel turds away.</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      if (isset($_SESSION['email'])) {
         ...
         $trans_result = $con->query("SELECT count(user_id) as total from transaction where `user_id`='$user_id' and `shiney_no_the_go`<>'0'");

         $trans_row = mysqli_fetch_assoc($trans_result);
         $total_trans = $trans_row['total'];

         $reviews = $con->query("SELECT count(user_id) as total from onthego_review where `user_id`='$user_id'");
