...
<html>
    <head>
        ...
        <title>Privacy Policy | Shiney Heinie</title>
    ...
    <body>
        ...
        <div class="privacy-policy-section">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 policy-desc">
                        <p>Protecting your private information is our priority. This Statement of Privacy applies to
                           shineyheinie.com, and BA23 PR LLC and governs data collection and usage. For the purposes of
                           this Privacy Policy, unless otherwise noted, all references to BA23 PR LLC include
                           shineyheinie.com and BA23. The BA23 website is a Ecommerce site. By using the BA23 website,
                           you consent to the data practices described in this statement. 
                        </p>
                        <h5>Collection of your Personal Information</h5>
                        <p>In order to better provide you with products and services offered, BA23 may collect personally
                        ...
                        <p>If you purchase BA23's products and services, we collect billing and credit card information. This
                        information is used to complete the purchase transaction</p>
                        <p>BA23 may also collect anonymous demographic information, which is not unique to you, such as your: </p>
                        <ul>
                            <li>Age</li>
                            <li>Gender</li>
                        </ul>
                        ...
                        <p>BA23 collects and uses your personal information to operate and deliver the services you have requested.</p>
                        <p>BA23 may also use your personally identifiable information to inform you of other products or services available from BA23 and its affiliates. </p>
                        <h5>Sharing Information with Third Parties</h5>
                        <p>BA23 does not sell, rent or lease its customer lists to third parties.</p>
                        <p>BA23 may, from time to time, contact you on behalf of external business partners about a
                        particular offering that may be of interest to you. In those cases, your unique personally identifiable
                        information (e-mail, name, address, telephone number) is not transferred to the third party. BA23
                        ...
                        using your personal information except to provide these services to BA23, and they are required
                        to maintain the confidentiality of your information.</p>
                        <p>BA23 may disclose your personal information, without notice, if required to do so by law or in the
                        good faith belief that such action is necessary to: (a) conform to the edicts of the law or comply
                        with legal process served on BA23 or the site; (b) protect and defend the rights or property of
                        BA23; and/or (c) act under exigent circumstances to protect the personal safety of users of BA23,
                        or the public. </p>
                        <h5>Tracking User Behavior</h5>
                        <p>BA23 may keep track of the websites and pages our users visit within BA23, in order to
                        determine what BA23 services are the most popular. This data is used to deliver customized
                        content and advertising within BA23 to customers whose behavior indicates that they are
                        ...
                        BA23. This information can include: your IP address, browser type, domain names, access times
                        and referring website addresses. This information is used for the operation of the service, to
                        maintain quality of the service, and to provide general statistics regarding use of the BA23 website.</p>
                        <h5>Links</h5>
                        ...
                        <ul>
                            <li>Complete the transaction for which the personal information was collected, fulfill the terms of a written warranty or product recall conducted in accordance with federal
                        ...
                        <p>BA23 does not knowingly collect personally identifiable information from children under the age of
                        thirteen. If you are under the age of thirteen, you must ask your parent or guardian for permission
                        to use this website. 
                        </p>
                        <h5>E-mail Communication</h5>
                        <p>From time to time, BA23 may contact you via email for the purpose of providing announcements,
                        promotional offers, alerts, confirmations, surveys, and/or other general communication. In order to
                        improve our Services, we may receive a notification when you open an email from BA23 or click
                        on a link therein. </p>
                        <br/>
                        <p>If you would like to stop receiving marketing or promotional communications via email from
                        BA23, you may opt out of such communications by clicking on the UNSUBSCRIBE button on
                        the bottom of the email.</p>
                        ...
                        <p>BA23 reserves the right to change this Privacy Policy from time to time. We will notify you about
                        ...
                        updating any privacy information. Your continued use of the website and/or Services available after such modifications will constitute your: (a) acknowledgment of the modified Privacy Policy;
