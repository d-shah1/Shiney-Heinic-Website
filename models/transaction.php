<?php
  ...
  class Transaction {
    ...
    public function addTransactionFull($data) {
      ...
      $bill_add = $data['bill_add'];
      $bill_country = $data['bill_country'];
      $bill_state = $data['bill_state'];
      $bill_zip = $data['bill_zip'];
      $product_first = $data['product_first'];
      $product_second = $data['product_second'];
      $status = $data['status'];
      $amount = $data['amount'];
      $time = $data['time'];
      $email = $data['email'];
      ...
      '$bill_country', '$bill_state', '$bill_zip', $product_first,$product_second, '$status','$amount','$time','$email','$phone','$user_id')";
