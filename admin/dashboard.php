                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <div class="form-group filed">
                                            ...
                                            <input type="text" class="form-control" name="input_1.1" id="customer_id"
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group filed">
                                            ...
                                            <input type="text" class="form-control" name="input_1.3" id="customer_name"
                                                disabled="disabled" required />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group filed">
                                            <label>Email</label>
                                            <input type="text" class="form-control" name="input_1.3" id="email"
                                                disabled="disabled" required />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group filed">
                                            <label>Phone</label>
                                            <input type="text" class="form-control" name="input_1.3" id="phone"
                                                disabled="disabled" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        ...
                                        <div class="form-group filed">
                                            <label>Address</label>
                                            <input type="text" name="input_1.4" class="form-control"
                                                id="shiping_address" disabled="disabled" required />
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-3">
                                        <div class="form-group filed">
                                            <label>Country</label>
                                            <input type="text" name="input_1.5" class="form-control" id="country"
                                                disabled="disabled" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>State</label>
                                            <input name="input_3" id="state" type="text" class="form-control"
                                                disabled="disabled" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>Zip</label>
                                            <input name="input_4" id="zip" type="text" class="form-control"
                                                disabled="disabled" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input name="input_6" id="bill_address" type="text" class="form-control"
                                                disabled="disabled" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>Country</label>
                                            <input name="input_7" id="country_bill" type="text" class="form-control"
                                                disabled="disabled" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>State</label>
                                            <input name="input_8" id="state_bill" type="text" class="form-control"
                                                disabled="disabled" class="medium" />
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>zip</label>
                                            <input name="input_10" id="zip_bill" type="text" disabled="disabled"
                                                class="form-control" class="medium" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group form-group-date">
                                            ...
                                            <input name="input_11" id="shiney_heinie_classic" disabled="disabled"
                                                type="text" class="form-control" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label>Shiney no the go quantity</label>
                                            <input name="input_14" id="shiney_no_the_go" disabled="disabled"
                                                type="number" class="form-control" value="" class="medium" min="1"
                                                max="10" />
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="form-group form-group-date">
                                            <label>Status</label>
                                            <input name="input_13" id="status" type="text" disabled="disabled"
                                                class="form-control" class="medium" />
                                        </div>
                                    </div>
                                    <div class="col-sm-4 col-md-4 col-lg-3">
                                        <div class="ginput_container ginput_container_email">
                                            <label>Amount</label>
                                            <input name="input_17" id="amount" disabled="disabled" type="text" value=""
                                    ...
                                    <table id="example5" class="display" style="min-width: 845px">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Customer Id</th>
                                                <th>Customer name</th>
                                                <th class="text-center">SPA 2.0</th>
                                                <th class="text-center">On The Go</th>
                                                <th>Amount</th>
                                                <th>Status</th>
                                                <th>TimeStamp</th>
                                                <th>Actions</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?= $row["shiney_heinie_classic"] ?>
                                                </td>
                                                <td class="text-center">
                                                    <?= $row["shiney_no_the_go"] ?>
                                                </td>
                                                <td>
                                                    <?= $row["amount"] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <a href="#" class="btn btn-secondary shadow btn-xs sharp mr-1"
                                                            data-toggle="modal" data-target="#editFormModalView"
                                                            onclick="fill_edit_details_view(<?= $row['id'] ?>)"><i
                                                                class="fa fa-eye"></i></a>
