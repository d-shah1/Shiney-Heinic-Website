        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="nav menu-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="review-list-classic.php">
                            <svg id="icon-home" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" class="feather feather-box">
                                <path
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Classic Product Reviews</h4>
