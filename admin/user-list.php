                ...
                <form onsubmit="create_new()" name="f1" id="create_form" method="POST">
                    <div class="modal-content">
                            ...
                            <div class="basic-form">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id='firstnameForm' placeholder="Name"
                                            required="required">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="emailForm">Last name</label>
                                        <input type="text" class="form-control" id='lastnameForm' placeholder="Email"
                                            required="required">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="password" id="password2" onkeyup="checkrps()" name="re_password"
                                            class="form-control" placeholder="Re Enter Password" required></input>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="submit" class="btn btn-primary" disabled="true">Save
                                changes</button>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Individual Users</h4>
