...
if (isset($_COOKIE['Remember_me_email']) && isset($_COOKIE['Remember_me_password'])) {
    ...
    $password =base64_decode(urldecode($_COOKIE['Remember_me_password']));
        ...
        <form action="authenticate.php" method="post" id="form1">
			<div class="sign-in-htm">
				...
				<div class="group">
					...
					<input id="user" value="<?= $email ?>" name="email" type="text" class="input">
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input id="pass" value="<?= $password ?>" type="password" name="password" class="input" data-type="password">
				</div>
				<div class="group">
            ...
            <form action="register.php" method="post" id="form2">
                ...
                <div class="group">
					<label for="no" class="label">Number</label>
					<input id="no" type="text" name="no"  class="input">
				</div>
				<div class="group">
